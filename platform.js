...
*/
    ...
    var Ia = function (a) {
            if (a instanceof x && a.constructor === x && a.ea === Ha)
                return a.S;
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var Qb = /^(\/[a-zA-Z0-9_\-]+)+$/,
            ...
            try {
                ...
                if (e && 0 < e.length) {
                    ...
                    for (d = {}; c < e.length; ) {
                        ...
                        f = ma(l)
                            ? "o" +
                              ((Object.prototype.hasOwnProperty.call(l, na) &&
                                  l[na]) ||
                                  (l[na] = ++oa))
                            : (typeof l).charAt(0) + l;
        ...
        Zb = function (a) {
            ...
            c = 0;
            for (d = Rb.length; c < d; ++c)
                Rb[c].test(b) && N("invalid_prefix");
            c = bc(a, "k", !0);
            d = bc(a, "am");
            e = bc(a, "rs");
            a = bc(a, "t");
    ...
    Bc.prototype.error = function (a) {
        this.i &&
            (this.i.error ? this.i.error(a) : this.i.log && this.i.log(a));
    };
    ...
    var Hc =
        ...
        Kc = function () {
            ...
            null == a &&
                (a = (a = window.location.href.match(Ic)) ? a[1] : null);
            if (null == a) return null;
            a = String(a);
            21 < a.length && (a = null);
            return a;
    ...
    var Lc,
        ...
        ld = function (a) {
            if (-1 !== T)
                return jd(), U ? t.JSON.stringify.call(t.JSON, a) : X(a);
        },
        md =
    ...
    pd.prototype.update = function (a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (
                var c = b - this.blockSize, d = 0, e = this.L, f = this.v;
                d < b;
    ...
    var Fd = {
        ...
        Jd = function (a, b, c, d, e) {
            ...
            try {
                ...
                f ||
                    ((f = (a ? new Va(Ua(a)) : va || (va = new Va())).ha(
                        "IFRAME"
                    )),
                    g &&
                        ((f.onload = function () {
    ...
    var ie = function (a, b) {
            return (
                ("string" === typeof a ? document.getElementById(a) : a) || b
            );
        },
        ke = function (a, b) {
            je(void 0, !1, a, b);
